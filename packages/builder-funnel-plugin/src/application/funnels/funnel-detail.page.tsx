...
const FunnelDetailPage: React.FC<FunnelDetailProps> = ({item, data, context, onBack, onRefresh}) => {
    ...
    console.log('[HIPPO COMMERCE]', JSON.parse(JSON.stringify(item.data)))
                            ...
                            return (
                                <tr key={step.slug} className="hover:bg-base-300/20">
                                    ...
                                    <td>
                                        ...
                                        {step.gep && <div
                                            className="text-xs font-mono text-base-content/40 mt-0.5">{step.gep}</div>}
                                    </td>
                                    <td>
                                    ...
                                    <td className="text-right">
                                        {existingPage ? (
                                            <button className="btn btn-ghost btn-xs"
                                                    onClick={() => handleEditPage(existingPage)}>
