...
import {
    ...
    BuilderProductTagContent, BuilderProductUseCaseContent
            ...
            },
            {
                ...
                subFields: [
                    ...
                    },
                    {
                        ...
                        type: 'select',
                        required: 'return options.get(profileField) === "Gender" || options.get(profileField) ===' +
                            ' "Type"',
                    ...
                    },
                    {
                        ...
                        friendlyName: 'Operator',
                        type: 'select',
                        required: 'return options.get(profileField) === "Age" || options.get(profileField) ===' +
                            ' "weight"',
